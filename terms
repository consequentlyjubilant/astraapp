...
If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: astracontact111@gmail.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
...
Cancellation
All purchases are non-refundable. 1. Open the App Store app. 2. Click your name. If you can't find your name, click Sign In. 3. Click Account Settings. 4. Scroll to Subscriptions, then click Manage. 5. Next to the subscription, click Edit. 6. Click Cancel Subscription. Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please email us at astracontact111@gmail.com.
Fee Changes
...
12. PRIVACY POLICY
We care about data privacy and security. Please review our Privacy Policy: https://www.vertventures.io/privacy. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.
...
25. DISCLAIMER OF LIABILITY
All apps produced by Vert Ventures are provided strictly for entertainment purposes only. While we endeavor to provide an engaging and thought-provoking experience, the advice and information offered by our products are generated through artificial intelligence, which means it might not be accurate, appropriate, or relevant to all individuals or situations. Please be advised that the content generated by our apps should not be relied upon for personal, medical, legal, or financial decisions. You should consult an appropriate professional for specific advice tailored to your situation. We do not accept any responsibility or liability for any actions taken or not taken on the basis of information provided by our products. The use of our products and any reliance on its output is at your own risk. We expressly disclaim any liability, whether direct or indirect, arising from your use of our products. By using our products, you acknowledge and agree to this disclaimer of liability.
